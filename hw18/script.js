function startTime() {
    ...
    document.getElementById("clock3").innerHTML = hr + ":" + min + ":" + sec + " " + ap;
    document.getElementById("clock4").innerHTML = hr + ":" + min + ":" + sec + " " + ap;
    document.getElementById("clock5").innerHTML = hr + ":" + min + ":" + sec + " " + ap;
